...
Functionality: **_Show off project only: Uses JPA and camel-bindy to seed a database from many different csv files_**
...
Git clone the xab_SeedDbFromManyCsvFiles project into your workspace:
...
cd xab_SeedDbFromManyCsvFiles
mvn install -DskipTests

```

You man now import xab_SeedDbFromManyCsvFiles into your IDE.
...
_This is a needlessly complex show-off project. Pursue simpler x_projects to learn the basics of jpa, bindy, etc_
